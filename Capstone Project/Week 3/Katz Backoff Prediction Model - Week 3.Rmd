...
subtitle: "Katz Backoff Prediction Model - Week 3"
author: "Ken Wood"
date: "10/17/2020"
output:
...
### Applying the Katz Backoff Algorithm:
...
#### Delete `samplecorpus`and `sample_corpus` files to free up memory since we don't need them anymore.
...
### Let's Check the Bigram Calculations
...
### Exploring an interesting question
