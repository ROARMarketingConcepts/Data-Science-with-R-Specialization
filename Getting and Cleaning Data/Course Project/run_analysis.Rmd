...
```{r Download the datafiles}

# Download the data files.
download.file("https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip","dataset.zip")
```

```{r Prepare the raw dataset.}
...
X_train <- read.table("X_train.txt", col.names=feature_vector,check.names = FALSE)
...
X_test <- read.table("X_test.txt", col.names=feature_vector,check.names = FALSE)
